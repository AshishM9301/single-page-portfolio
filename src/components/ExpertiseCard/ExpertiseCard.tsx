  ...
  return (
    <div className="rounded-xl bg-gray-100 border-gray-200 shadow-sm hover:shadow-md w-[350px] h-[300px] duration-200 py-4 group">
      <div className="border-b-[5px] border-orange-600 px-8 ">
        <p className="text-[28px] font-medium tracking-wide text-center uppercase mt-4 -mb-3 group-hover:mb-2 duration-200">
          {title}
        </p>
      </div>
      <div className="px-8">
        <div>
          <p className="text-[26px] font-normal tracking-wide uppercase text-blue-950 mt-6 text-left break-keep">
            {expertTags}
          </p>
        </div>
        <div>
